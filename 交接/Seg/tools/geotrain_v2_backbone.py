...
from engine.geo_v2_backbone import MemoryEnhancedGeoSegformer, create_memory_enhanced_geo_segformer
...
def main(args: Namespace):
    ...
    model = create_memory_enhanced_geo_segformer(
        ...
        backbone_type="mask2former",  # 🔥 選擇backbone
        model_size=args.model_size,   # small, base, large
