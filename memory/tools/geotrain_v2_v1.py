...
from engine.geo_v2_v1 import MemoryEnhancedGeoSegformer, create_memory_enhanced_geo_segformer
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--retrieval-difficulty", type=float, default=0.3, 
                       help="Memory retrieval difficulty (0-1)")
    parser.add_argument("--memory-noise", type=float, default=0.05, 
                       help="Memory noise strength")
    parser.add_argument("--max-memories-per-retrieval", type=int, default=3, 
                       help="Max memories per retrieval")
...
def main(args: Namespace):
    ...
    model = create_memory_enhanced_geo_segformer(
        ...
        # ⭐ 使用args中的參數
        retrieval_difficulty=args.retrieval_difficulty,
        memory_noise=args.memory_noise,
        max_memories_per_retrieval=args.max_memories_per_retrieval
    ).to(device)
